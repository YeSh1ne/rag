...
|    256-1Y   |   10  |      BGE-M3     | deepseekV4-Pro |   0.810  |   0.952  |   0.976  | 0.875 | 0.841 | 0.915 |
|    1024-Y   |   5   |      BGE-M3     | deepseekV4-Pro |   0.738  |   0.857  |   0.929  | 0.809 | 0.793 | 0.849 |
|    1024-Y   |   10  |      BGE-M3     | deepseekV4-Pro |   0.738  |   0.857  |   0.929  | 0.809 | 0.716 | 0.866 |
|    512-1Y   |   5   | Qwen3-Embedding | deepseekV4-Pro |   0.929  |   0.952  |   0.976  | 0.945 | 0.885 | 0.903 |
|    512-1Y   |   10  | Qwen3-Embedding | deepseekV4-Pro |   0.952  |   0.952  |   0.976  | 0.957 | 0.827 | 0.900 |
|    256-1Y   |   5   | Qwen3-Embedding | deepseekV4-Pro |   0.890  |   0.929  |   0.976  | 0.864 | 0.849 | 0.922 |
|    256-Y    |   10  | Qwen3-Embedding | deepseekV4-Pro |   0.810  |   0.929  |   0.976  | 0.860 | 0.845 | 0.922 |
...
- **评测逻辑**：
  ...
  4. 若相似度超过预设阈值（此系统采用 0.67），则判定该 chunk 命中。
...
- **评测逻辑**：
  ...
  4. 若相似度超过预设阈值（此系统采用0.67），则判定该引用命中；若该 Gold 尚未被命中过，则计为正确引用（TP），否则不计分。
